...
{
    HEAP_BLOCK_TABLE_ENTRY entry[COS16_MAX_HEAP_ALLOCATIONS];
};
...
struct heap
{
    ...
    struct heap_entry entries[COS16_MAX_HEAP_ALLOCATIONS];

    // Actual data for our heap
    char data[COS16_MAX_HEAP_ALLOCATIONS * COS16_MEMORY_BLOCK_SIZE];
};
